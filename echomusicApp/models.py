...
class Usuario(models.Model):
    ...
    foto_perfil = models.ImageField(null=True, blank=True, default='/default/img_perfil.svg')
...
class Album(models.Model):
    ...
    imagen = models.ImageField(null=True, blank=True, default='/default/img_album.svg')
    usuario = models.ForeignKey(Usuario, null=False, blank=False, on_delete=models.CASCADE)

class Cancion(models.Model):
    nombre = models.CharField(max_length=30, null=False, blank=False, unique=True)
    autor = models.CharField(max_length=30, null=False, blank=False)
    imagen = models.ImageField(null=False, blank=False, default='/default/img_album.svg')
